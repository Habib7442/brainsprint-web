...
import { Sparkles, Brain, Trophy, Zap, Gamepad2, Timer, Bot, Users } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <FeatureCard
              ...
              title="AI & Everything"
              description="Get instant, exam-style questions generated by AI. Never run out of practice material for Reasoning or Maths."
            />
            <FeatureCard
            ...
            />
             <FeatureCard
              ...
              title="Study Rooms"
              description="Create private or public rooms to race against friends in real-time. Who solves it faster?"
            />
            <FeatureCard
